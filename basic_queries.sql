...
INSERT INTO authors VALUES (9, 'Guy Liechty', 'USA', 1990);

-- Add two books that you'd like to write (you can hard-code your id as the author id)
INSERT INTO books VALUES (69, 'When the Cell Phone Died', 2017, 9);
INSERT INTO books VALUES (70, 'Dreams of SQaLity', 2019, 9);

-- Update one of your books to have a new title
UPDATE books SET title='Kambucha Diaries' WHERE title='When the Cell Phone Died';

-- Delete your books
DELETE FROM books WHERE author_id=9;
-- Delete your author entry
DELETE FROM authors WHERE name='Guy Liechty';
